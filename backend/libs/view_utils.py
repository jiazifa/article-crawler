...
class ResponseCtx():
    ...
    def __init__(self, code: int = 200, msg: str = "", server_at: Optional[int] = None) -> None:
        self.code = code
        self.msg = msg
...
response_context_model = Model("ResponseContextModel", {
    "code": fields.Integer(readonly=True, required=False, description="Response code"),
    "msg": fields.String(readonly=True, required=False, description="Message"),
    "server_at": fields.Integer(readonly=True, required=False, description="Server time")
})
response_schema = Model("ResponseModel", {
